...
def _flatten_rgba(bgr: np.ndarray, alpha: np.ndarray, bg_rgb: tuple[int, int, int], threshold: int) -> np.ndarray:
...
def load_image_rgba_handled(path: str, bg_color: str, alpha_mode: str = "ignore", alpha_threshold: int = 0) -> np.ndarray:
